...
function Home() {
  ...
  return (
    <div className="grid h-screen grid-rows-[300px_auto_1fr]">
      {/* First Row - Fixed Height */}
      <div className="bg-blue-200 w-full h-[300px] flex flex-col items-start justify-center p-20">
        <p className="text-white text-4xl pb-5 text-darkBlue">Start Hangout</p>
